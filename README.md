<h1 align="center" >📱 HACKTOBERFEST 2023 GDSC GTBIT - App Dev 📱</h1>
<h2>
...
**0.** Take a look at the existing [issues](https://github.com/dsc-gtbit/HacktoberFest-23-AppDev/issues). Wait for the Issue to be assigned to you after which you can start working on it.

**1.** Fork [this](https://github.com/dsc-gtbit/HacktoberFest-23-AppDev) repository.
...
```
git remote add upstream https://github.com/dsc-gtbit/HacktoberFest-23-AppDev.git
